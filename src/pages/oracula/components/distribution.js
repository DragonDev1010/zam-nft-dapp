...
export const Distribution = ({ level, beltColor, nftCount, soldAlloc}) => {

  return (
    <div className="profile-card">
      <div className="profile-card__title">
        <img className="profile-card__title-icon" src="./images/profile/profile.png" /> <span className="profile-card__title-text">Ready for distribution</span> 
      </div>
