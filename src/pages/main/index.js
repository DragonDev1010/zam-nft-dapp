    ...
    return (
        <article className="background-glow">
            ...
            <div className="main-cards">
                <MainCard className="main-card main-card__bg_1" text={<>Create <span>DeFi Wallet</span> in ZamWallet</>} href="/"/>
                <MainCard className="main-card main-card__bg_2" text={<><span>Swap</span> ZAM token<br/>via DEX</>} button="Swap ZAM" href="/swap"/>
                <MainCard className="main-card main-card__bg_3" text={<>Staking ZAM <br/>Up to <span>89% APR</span></>} button="Stake ZAM" href="/stake"/>
